...
!function (a) {
    ...
    c.prototype.set = function (a, b, c) {
        ...
        var f, g, h, i, j = this, k = c, l = d && d.interval ? d.interval : 1, m = -1 === j.item.enable, n = j.item.min,
        ...
        var b = this, c = b.settings, f = b.item, g = f.now, h = f.select, i = f.highlight, j = f.view, k = f.disable,
            l = f.min, m = f.max, n = function (a, b) {
            ...
            }((c.showWeekdaysFull ? c.weekdaysFull : c.weekdaysShort).slice(0), c.weekdaysFull.slice(0)), o = function (a) {
